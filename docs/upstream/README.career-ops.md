<!--
Upstream original, preserved verbatim below this header for attribution and as a
reference to the career-ops engine this project is built on. Not maintained here:
see https://github.com/santifer/career-ops for the current version. Relative links
inside resolve against the upstream repository root, not this directory.
-->
